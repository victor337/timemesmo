import 'package:timemesmo/SegundasTelas/dadospartida.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';



class BancoHistorico extends StatelessWidget {

  final DocumentSnapshot snapshot;

  BancoHistorico(this.snapshot);
                ...
                ListTile(
                  ...
                  onTap: (){
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => DadosPartida(snapshot))
                      );
                  }
                ),
                Divider(),
